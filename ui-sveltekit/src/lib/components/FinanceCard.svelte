...
{:else if transaction}
    <div class="bg-slate-900/60 border border-indigo-500/30 rounded-xl overflow-hidden shadow-xl backdrop-blur-md group hover:border-indigo-500/50 transition-all duration-300 max-w-sm">
