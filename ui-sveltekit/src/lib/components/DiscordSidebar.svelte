...
{#snippet utilityContent()}
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 py-4 pb-12">
        ...
        <button onclick={() => { popupStore.closeLast(); goto('/canvas/tasks'); }} class="flex flex-col items-center gap-3 p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-sky-500/50 hover:bg-sky-500/5 transition-all group">
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-slate-500 group-hover:text-slate-200">Orchestrator Canvas</span>
        </button>
        ...
        {#if profileStore.currentUser?.role === 'admin'}
            ...
            <button onclick={() => { popupStore.closeLast(); goto('/admin/storage'); }} class="flex flex-col items-center gap-3 p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-purple-500/50 hover:bg-purple-500/5 transition-all group">
                <div class="p-3 rounded-xl bg-slate-800 group-hover:bg-purple-500/20 text-slate-400 group-hover:text-purple-400 transition-colors">
                    <Database size={24} />
                </div>
                <span class="text-[10px] font-black uppercase tracking-widest text-slate-500 group-hover:text-slate-200">Storage Monitor</span>
            </button>
