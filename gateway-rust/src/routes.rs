...
pub fn create_router(state: AppState) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route("/friends", get(crate::feature::friendship::handle_get_friends))
        .route("/friends/requests", post(crate::feature::friendship::handle_send_friend_request))
        .route("/friends/requests/respond", post(crate::feature::friendship::handle_respond_friend_request))
        .route("/friends/requests/pending", get(crate::feature::friendship::handle_get_pending_requests))
        .route("/friends/block", post(crate::feature::friendship::handle_block_user))
